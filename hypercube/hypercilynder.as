package 
{
	 ...
	 */
	public class hypercilynder extends MovieClip 
	{
		...
		public function hypercilynder():void 
		{	
		...
		public function init3D():void
		{
			...
			{
				cubeDrop[c] = new Cylinder(flatShadeMaterial, cubeSize, cubeSize, 20);
		...
		public function animationLoop():void
		{
			...
			default_camera.rotationX += (default_camera.extra.xRothome - default_camera.rotationX)/100;
			default_camera.rotationY += (default_camera.extra.yRothome - default_camera.rotationY)/100;
			default_camera.rotationZ += (default_camera.extra.zRothome - default_camera.rotationZ)/100;
