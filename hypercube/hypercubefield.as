package 
{
	 ...
	 */
	public class hypercubefield extends MovieClip 
	{
		...
		public var nCubeDrops:int = 40;		
		public var cubeSize:int = 240;
		public var xBoundsA:Number = -5000;
		public var xBoundsB:Number = 5000;
		public var yBoundsA:Number = -4000;
		public var yBoundsB:Number = 1000;
		public var zBoundsA:Number = 0;
		public var zBoundsB:Number = 5000;
		...
		public function hypercubefield():void 
		{	
		...
		public function animationLoop():void
		{
			...
			for (var c:int = 0; c < nCubeDrops; c++ )
			{
				...
				cubeDrop[c].y += 20;
				if(cubeDrop[c].y > cubeDrop[c].extra.yBounds){
					cubeDrop[c].x = xBoundsA + Math.floor(Math.random()*(xBoundsB - xBoundsA));
					cubeDrop[c].y = yBoundsA;
					cubeDrop[c].z = zBoundsA + Math.floor(Math.random()*(zBoundsB - zBoundsA));
